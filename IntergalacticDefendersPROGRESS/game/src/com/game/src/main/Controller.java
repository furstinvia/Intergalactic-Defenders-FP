...
public class Controller extends JPanel {
    ...
    private int spawn_count = 0; // buat jumlah yg telah di spawn atau diciptakan
    private int spawn_killed = 0; // Jumlah musuh yang terbunuh setelah spawn
    private int enemy_killed; // Total musuh yang harus dibunuh
    ...
    // Metode untuk pembaruan (update) logika permainan
    public void tick() {
        ...
        // Loop untuk memperbarui logika dari setiap EntityA 
    ...
    public void render(Graphics g) {
        ...
        // jumlah nyawa musuh yang tersisa
    ...
    // metode untuk memulai permainan dengan menentukan jumlah musuh berdasarkan tingkat kesulitan
    public void start() {
        if (Game.diff == DIFFICULTY.EASY) {
            enemy_killed = 200;
            addEnemy(10);
        } else if (Game.diff == DIFFICULTY.MEDIUM || Game.diff == DIFFICULTY.HARD) {
            enemy_killed = 100;
            addEnemy(10);
        }
    }
